export const es = {
  ...
  editProfile: "Editar",
  profileDownloadSample: "Descargar muestra de voz",
  useProfile: "Usar",
  ...
  previewClonedVoice: "Probar voz clonada",
  ...
  convertTargetCatalog: "Catálogo",
  convertTargetFile: "Fichero",
  convertCatalogHint: "Aplica el timbre de una voz del sistema a tu narración (conserva tu entonación).",
  convertOrRecord: "o graba directamente",
  convertDownloadSource: "Descargar grabación",
  ...
  convertTau: "Intensidad (tau)",
  infoConvertTau: "Temperatura del conversor OpenVoice (experimental). Más bajo = más estable y limpio (menos metálico); más alto = más expresivo pero con más artefactos. 0.3 por defecto.",
  convertDenoise: "Limpiar fuente (denoise)",
  infoConvertDenoise: "Reduce el ruido del audio original antes de convertir. Útil si tu grabación tiene siseo o ruido de fondo; deja menos artefactos metálicos.",
  ...
  expCandidatePlayerLabel: "Versión {n} generada",
  ...
  chapterStatusMastered: "Masterizado ✓",
  chapterOpenInStudio: "Abrir en Studio",
  chapterMaster: "Masterizar",
  chapterMasterSuccess: "Capítulo masterizado — el export usará esta versión",
  chapterExportSourceStudio: "Exportará: edición Studio de {when}",
  chapterExportSourceMastered: "Exportará: máster de {when}",
  chapterExportSourceActive: "Exportará: take activo",
  chapterExportSourceLatest: "Exportará: última síntesis",
  chapterExportSourceFresh: "Exportará: se sintetizará al exportar",
  chapterDiscardEdit: "Descartar edición",
  confirmDiscardEditTitle: "Descartar edición de Studio",
  confirmDiscardEdit:
    "El export dejará de usar esta edición y volverá al audio del capítulo. El archivo editado se elimina y no se puede recuperar.",
  chapterEditDiscarded: "Edición descartada — el export vuelve al audio del capítulo",
  workbenchMasterOnExport: "Masterizar todo al exportar",
  ...
  chapterTakeEngineConverted: "Re-vozeada",
  chapterTakeActive: "Activa",
  chapterAudioPlayerLabel: "Audio del capítulo (toma activa)",
  ...
  recorderPreviewLabel: "Vista previa de la grabación",
  ...
  chunkMapLoadError: "No se pudo cargar el mapa de chunks",
  chapterStatusLoadError: "No se pudo cargar el estado del capítulo",
  retry: "Reintentar",
  chunkRegen: "Regen",
  chunkRegenerating: "...",
  ...
  studioScenesGenNote: "El proveedor configurado es 'placeholder' (imagen de previsualización con el texto del prompt). Configura VOXFORGE_IMAGE_PROVIDER=comfyui para imágenes reales.",
  studioImageProviderOffline: "El proveedor de imágenes no está disponible",
  ...
  chapterDownloadTake: "Descargar audio",
  chapterApplyVoiceLabel: "Aplicar voz",
  chapterApplyVoicePick: "Elige un perfil o voz…",
  chapterApplyVoiceButton: "Aplicar voz",
  chapterApplyVoiceHint: "Cambia el timbre a un perfil tuyo o a una voz del catálogo, conservando tu entonación. Crea una toma nueva (no borra esta). La primera conversión tarda; las siguientes van rápidas.",
  chapterApplyVoiceDone: "Voz aplicada · nueva toma activa",
  chapterApplyVoiceDenoise: "Limpiar fuente",
  chapterApplyVoiceDenoiseHint: "Reduce el ruido de tu grabación antes de convertir (menos artefactos metálicos).",
  chapterTranscribe: "Transcribir",
  chapterTranscribeHint: "Transcribe el audio y rellena el texto del capítulo (para QC, subtítulos alineados y re-síntesis). Sobrescribe el texto actual.",
  chapterTranscribeDone: "Transcrito · {words} palabras en el texto",
  ...
  jobKindImageGen: "Generación de imagen",

  // T2I-2: sección de Imágenes del Estudio (biblioteca de medios)
  studioModeAudio: "Audio",
  studioModeImages: "Imágenes",
  studioModeMontage: "Montaje",
  studioModeMontageSoon: "Próximamente",
  studioImagesTagline: "Genera imágenes por prompt y reutilízalas como portadas o escenas.",
  studioComposerTitle: "Generar imagen",
  studioComposerCount: "Cuántas",
  studioComposerCountHint: "1–4 imágenes por lote (se generan secuencialmente).",
  studioComposerSubmit: "Generar",
  studioComposerSubmitN: "Generar {n}",
  studioComposerRandomize: "Aleatorio",
  studioComposerGenerating: "Generando…",
  studioComposerGenSuccess: "Generada(s) {n} imagen(es)",
  studioMediaBinTitle: "Biblioteca",
  studioMediaBinEmpty: "Aún no hay imágenes. Genera una arriba para empezar tu biblioteca.",
  studioMediaBinSearch: "Buscar por prompt…",
  studioMediaBinRefresh: "Actualizar",
  studioMediaBinDelete: "Eliminar imagen",
  studioMediaBinUseAsCover: "Usar como portada",
  studioMediaBinEnlarge: "Ampliar imagen",
  studioMediaBinDownload: "Descargar imagen",
  studioMediaBinClose: "Cerrar",
  studioMediaBinCoverSet: "Establecer como portada del vídeo",
  studioMediaBinSeed: "semilla {seed}",
  studioMediaBinOriginGenerated: "Generada",
  studioMediaBinOriginUpload: "Subida",
  studioMediaBinOriginImported: "Importada",
  studioMediaBinConfirmDelete: "¿Eliminar esta imagen de la biblioteca? No se puede deshacer.",
} as const;
