...
export const en: Record<TranslationKey, string> = {
  ...
  synthPacingInfo: "Lengthens the pauses between sentences and paragraphs without touching the audio: the free, artifact-free way to make narration feel more measured. Speed changes articulation (how fast the words come out); Pacing only changes the silences. 1.0x keeps the base pauses.",
  pitch: "Pitch",
  volume: "Volume",
  ...
  convertTargetCatalog: "Catalog",
  convertTargetFile: "File",
  convertCatalogHint: "Apply a system voice's timbre to your narration (keeps your intonation).",
  convertOrRecord: "or record directly",
  convertDownloadSource: "Download recording",
  ...
  convertTau: "Intensity (tau)",
  infoConvertTau: "OpenVoice converter temperature (experimental). Lower = stabler and cleaner (less metallic); higher = more expressive but more artifacts. Default 0.3.",
  convertDenoise: "Clean source (denoise)",
  infoConvertDenoise: "Reduce noise in the source audio before converting. Useful if your recording has hiss or background noise; leaves fewer metallic artifacts.",
  ...
  chapterTakeEngineConverted: "Re-voiced",
  ...
  chapterDownloadTake: "Download audio",
  chapterApplyVoiceLabel: "Apply voice",
  chapterApplyVoicePick: "Pick a profile or voice…",
  chapterApplyVoiceButton: "Apply voice",
  chapterApplyVoiceHint: "Change the timbre to one of your profiles or a catalog voice, keeping your intonation. Creates a new take (doesn't delete this one). The first conversion is slow; the next ones are fast.",
  chapterApplyVoiceDone: "Voice applied · new active take",
  chapterApplyVoiceDenoise: "Clean source",
  chapterApplyVoiceDenoiseHint: "Reduce noise in your recording before converting (fewer metallic artifacts).",
  chapterTranscribe: "Transcribe",
  chapterTranscribeHint: "Transcribe the audio and fill the chapter text (for QC, aligned subtitles and re-synthesis). Overwrites the current text.",
  chapterTranscribeDone: "Transcribed · {words} words into the text",
  ...
  studioMediaBinEnlarge: "Enlarge image",
  studioMediaBinDownload: "Download image",
  studioMediaBinClose: "Close",
