...
export interface components {
    schemas: {
        ...
        /** UploadedChapterGenerationResponse */
        UploadedChapterGenerationResponse: {
            /** Id */
            id: string;
            /** Chapter Id */
...
export interface operations {
    ...
    list_takes_api_projects_generations__generation_id__takes_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TakeResponse"][];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    extract_chars_api_character_synth_extract_characters_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ExtractCharactersRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ExtractCharactersResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    analyze_sample_api_analyze_sample_post: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SampleAnalysisResponse"];
                };
            };
            /** @description Validation Error */
            422: {
